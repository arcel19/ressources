...
<x-layout>
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Military Region</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                    <li class="breadcrumb-item active">Military Region</li>
                </ul>
            </div>
            <div class="col-auto float-right ml-auto">
                <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_designation"><i
                        class="fa fa-plus"></i> Add Military Region</a>
            </div>
        </div>
    </div>
    <!-- /Page Header -->
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Edit military region</h5>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('militaryRegion.update',$nat->id) }}" method="POST">
                                                @method('put')
                                                @csrf

                                                <div class="form-group">
                                                    <label>Military region Name <span class="text-danger">*</span></label>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form action="{{ route('militaryRegion.destroy', $nat->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
    ...
    <div id="add_designation" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add military region</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('militaryRegion.store') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label>Military region Name <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label>National army <span class="text-danger">*</span></label>
                            <select class="select" name="id">
                                @foreach (\App\Models\NationalArmy::all() as $army )
