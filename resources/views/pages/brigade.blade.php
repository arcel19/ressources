...
<x-layout>
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Brigade</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                    <li class="breadcrumb-item active">Brigade</li>
                </ul>
            </div>
            <div class="col-auto float-right ml-auto">
                <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_designation"><i
                        class="fa fa-plus"></i> Add Brigade</a>
            </div>
        </div>
    </div>
    <!-- /Page Header -->
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Edit Brigade</h5>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('brigade.update',$nat->id) }}" method="POST">
                                                @method('put')
                                                @csrf

                                                <div class="form-group">
                                                    <label>Brigade Name <span class="text-danger">*</span></label>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="form-header">
                                                <h3>Delete Brigade</h3>
                                                <p>Are you sure want to delete?</p>
                                            </div>
                                            <form action="{{ route('brigade.destroy', $nat->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
    ...
    <div id="add_designation" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Brigade</h5>
                    ...
                    <form action="{{ route('brigade.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select" name="id">
                                @foreach (\App\Models\MilitaryRegion::all() as $army )
