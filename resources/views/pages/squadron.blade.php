...
<x-layout>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Edit Squadron</h5>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('squadron.update',$nat->id) }}" method="POST">
                                                @method('put')
                                                @csrf
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="form-header">
                                                <h3>Delete Squadron</h3>
                                                <p>Are you sure want to delete?</p>
                                            </div>
                                            <form action="{{ route('squadron.destroy', $nat->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
    ...
    <div id="add_designation" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add squadron</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('squadron.store') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label>Squadron Name <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <label>select Platoon <span class="text-danger">*</span></label>
                            <select class="select" name="id">
                                @foreach (\App\Models\Platoon::all() as $army )
